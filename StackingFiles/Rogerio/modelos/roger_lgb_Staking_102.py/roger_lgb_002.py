...
for i in range(0, 1879, 1):
    ...
    model = train_lgb(d_train, d_valid, val_sets=[d_train, d_valid], n_rounds=100)
...
preds_df.to_csv("G:\\Meu Drive\\LP&D\\DMC_2019_task\\DMC\\Roger\\Staking\\roger_lgb_"+identificador+"_train.csv")
...
preds_df['index'] = preds_df['index']+1
preds_df.rename(columns={'index': 'ID'},inplace=True)
preds_df.to_csv("G:\\Meu Drive\\LP&D\\DMC_2019_task\\DMC\\Roger\\Staking\\roger_lgb_"+identificador+"_test.csv")
