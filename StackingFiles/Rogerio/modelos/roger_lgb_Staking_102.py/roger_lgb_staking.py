...
for nomes in arquivos:
    metaTrain = pd.read_csv("G:\\Meu Drive\\LP&D\\DMC_2019_task\\DMC\\Modelos\\"  +nomes+  "_train.csv",delimiter = ",")
    metaTest = pd.read_csv("G:\\Meu Drive\\LP&D\\DMC_2019_task\\DMC\\Modelos\\"  +nomes+  "_test.csv", delimiter = ",")
...
for i in range(0, 1879, 1):
    ...
    model = train_lgb(d_train, d_valid, val_sets=[d_train, d_valid], n_rounds=150)
