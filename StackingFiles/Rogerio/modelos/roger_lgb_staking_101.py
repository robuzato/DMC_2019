...
arquivos =os.listdir("../Modelos Estabilizados")
...
for nomes in trains:
    metaTrain = pd.read_csv("../Modelos Estabilizados/"+nomes ,delimiter = ",")
    train[nomes[:-10]] = metaTrain['Score']
    
for nomes in tests:
    metaTest = pd.read_csv("../Modelos Estabilizados/"+nomes ,delimiter = ",")
